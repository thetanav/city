...
export default function SettingsPage() {
  ...
  const profileQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      return data as { name?: string | null; email?: string | null; bio?: string | null };
    },
  });
  ...
  const eventsQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      return items.map(normalizeEdenEvent);
    },
  });
  ...
  const updateEventMutation = useMutation({
    mutationFn: async ({
      ...
      return normalizeEdenEvent(data as EdenEventItem);
    },
    onSuccess: (updated) => {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async (payload: { name: string; bio: string | null }) => {
      const { error } = await api.profiles.put(payload);
      if (error) {
